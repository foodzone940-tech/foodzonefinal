...
router.put(
  ...
  [
    body('status')
      .isIn(['ACCEPTED', 'PREPARING', 'DISPATCHED', 'DELIVERED', 'CANCELLED'])
...
router.put(
  '/bank-details',
  [
    body('accountHolder').trim().notEmpty().withMessage('Account holder is required'),
  ...
  asyncHandler(upsertVendorBankDetails)
);
